...
{
    public class Gene_SuperhumanSpeed : Gene
    {
        ...
        {
            return pawn.health.hediffSet.GetFirstHediffOfDef(Definitions.V_SuperhumanSpeed);
        }
        ...
        public void ApplyHediff()
        {
            if (GetHediff() == null)
            {
                Hediff hediff = HediffMaker.MakeHediff(Definitions.V_SuperhumanSpeed, pawn);
