...
{
    public class Gene_SuperhumanStrength : Gene
    {
        ...
        {
            return pawn.health.hediffSet.GetFirstHediffOfDef(Definitions.V_SuperhumanStrength);
        }
        ...
        public void ApplyHediff()
        {
            if (GetHediff() == null)
            {
                Hediff hediff = HediffMaker.MakeHediff(Definitions.V_SuperhumanStrength, pawn);
