...
namespace Viltrumites
{
    ...
    public class ActiveDropViltrumite : ActiveTransporter
    {
        public Pawn pawn;
        ...
        protected override void LeaveMap()
        {
            ...
            for (int i = 0; i < tmpActiveDropPods.Count; i++)
            {
                if (tmpActiveDropPods[i] is FlyShipLeaving flyShipLeaving && flyShipLeaving.groupID == groupID)
                {
                    ...
                    travelingPawn.AddTransporter(flyShipLeaving.Contents, justLeftTheMap: true);
    ...
    public class TravelingViltrumite : TravellingTransporters
    {
        ...
        public void ArrivedOverride()
        {
            ...
            if (arrivalAction == null || !arrivalAction.StillValid(traverse2.GetValue<List<ActiveTransporterInfo>>(), destinationTile))
            {
                arrivalAction = null;
            ...
            if (arrivalAction != null && arrivalAction.ShouldUseLongEvent(traverse2.GetValue<List<ActiveTransporterInfo>>(), destinationTile))
            {
    ...
    public class ViltrumiteArrivalAction_LandInSpecificCell : TransportersArrivalAction_LandInSpecificCell
    {
        ...
        public override void Arrived(List<ActiveTransporterInfo> transporters, PlanetTile tile)
        {
            ...
            DropTravelingPawns(transporters, mapParent.Map.Center, mapParent.Map);
    ...
    public class ViltrumiteIncoming : DropPodIncoming
    {
        ...
        protected override void Impact()
        {
            ...
            GenExplosion.DoExplosion(positionHeld, mapHeld, 15f, bomb, instigator, 15, -1f, null, null, null, null, null, 0f, 1, null, null, 255, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, ignoredThings);
        }
